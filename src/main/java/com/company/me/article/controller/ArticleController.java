package com.company.me.article.controller;
...
import com.company.me.article.service.ArticleService;
...
public class ArticleController {
	...
	public String writePOST(Article article, RedirectAttributes redirectAttributes) throws Exception{
		logger.info("write POST...");
		logger.info(article.toString());
		articleService.create(article);
		redirectAttributes.addFlashAttribute("msg", "regSueccess");
	...
	public String modifyPOST(Article article, RedirectAttributes redirectAttributes) throws Exception {
		logger.info("modifyPOST...");
		articleService.update(article);
		redirectAttributes.addFlashAttribute("msg", "modSucess");
		
		return "redirct:/article/list";
	}
